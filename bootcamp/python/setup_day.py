#!/usr/bin/env python3
"""
Setup script for creating new day folders in the DSP bootcamp.
Usage: python setup_day.py <week> <day> [topic]
"""
...
def setup_day(week_num, day_num, topic=None):
    ...
    try:
        ...
        print(f"Updated main.py with day {day_num} information")
    ...
    print(f"🚀 Start coding: python main.py")
